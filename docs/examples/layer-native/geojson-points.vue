 ...
 * @LastEditTime: 2024-06-15 19:01:57
 * @FilePath: \vue-maplibre\docs\examples\layer-native\geojson-points.vue
-->
<template>
  <div class="map-demo-container">
    <VmMap :map-style="mapStyle" :center="center" :zoom="zoom" @ready="onMapReady">
      ...
      <VmLayerNative v-if="isMapReady" id="openstreetmap-tiles" type="raster" :source="sourceOl"></VmLayerNative>
    </VmMap>
  </div>
</template>
...
import { LngLatLike, GeoJSONSourceSpecification, SymbolLayerSpecification, StyleSpecification, SourceSpecification } from 'maplibre-gl'
import { ref } from 'vue'
...
const glyphsURL = `https://dps.cloudtao.com.cn/public/font/glyphs`
const spriteURL = `https://dps.cloudtao.com.cn/public/font/sprite/sprite`
...
const sourceOl: SourceSpecification = {
  type: 'raster',
