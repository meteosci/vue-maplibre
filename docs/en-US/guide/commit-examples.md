...
You can checkout the allowed values for **type** and **scope** in [commitlint.config.js](https://github.com/meteosci/vue-maplibre/blob/dev/commitlint.config.js#L41),
