 ...
 * @LastEditTime: 2024-04-18 00:23:56
 * @FilePath: \vue-maplibre\demo\src\pages\map\Index.vue
-->
<template>
  <div class="page-demo-map" style="width: 100%; height: 100%">
    <VmMap ref="mapRef" map-style="https://demotiles.maplibre.org/style.json" :center="center" :zoom="zoom" @click="onClick" @ready="onMapReady" @load="onLoad">
...
import { ref } from 'vue'
import { VmMap, VmLayerGltf, VmLayerGltfProps } from '@vue-maplibre/components'
