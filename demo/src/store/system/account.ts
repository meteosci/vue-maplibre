 ...
 * @LastEditTime: 2024-03-23 16:44:51
    ...
    logout({ confirm = false } = {}) {
      return new Promise((resolve, reject) => {
        ...
        async function logout() {
          ...
          //   'http://gx.uts.cma:18010/idp/profile/OAUTH2/Redirect/GLO?redirctToUrl=http://10.158.48.67:9002/login?source=authoLogout&redirectToLogin=true&entityId=gxDAAS'
          // 跳转路由
